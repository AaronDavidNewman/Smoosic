...
class SmoHelp {
  ...
  static get helpHtml() {
    return [
      {title:'Quick Start',html:quickStartHtml},
      {title:'Selections and Selecting Things',html:selectionHtml},
      {title:'Entering Music (Pitches)',html:enterPitchesHtml},
      {title:'Entering Music (Durations)',html:enterDurationsHtml}
    ];
  }
}
