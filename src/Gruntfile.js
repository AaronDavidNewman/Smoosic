        ...
        concat: {
            ...
            dist: {
                src: ['src/common/vexHelpers.js', 'src/common/svgHelpers.js', 'src/common/htmlHelpers.js',
                    '/src/smo/data/note.js', '/src/smo/data/measure.js', '/src/smo/data/systemStaff.js', '/src/smo/data/staffModifiers.js',
            ...
            tests: {
                src: ['src/test/chordTest.js', 'src/test/staffTest.js', '/src/test/timeSignatureTest.js',
                    'src/test/tupletTest.js', 'src/test/voiceTest.js', 'src/test/testAll.js'],
