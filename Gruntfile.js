        ...
        concat: {
            ...
            dist: {
                src: ['src/common/musicHelpers.js', 'src/common/svgHelpers.js', 'src/common/htmlHelpers.js',
                    ...
                    'src/ui/ribbon.hs','src/ui/dialog.js', 'src/ui/staffDialogs.js', 'src/ui/help.js', 'src/ui/controller.js'],
            ...
            tests: {
                src: ['src/test/chordTest.js', 'src/test/undoTest.js', 'src/test/timeSignatureTest.js',
                    ...
                    'src/test/voiceTest.js', 'src/test/trackerTest.js', 'src/test/clefTest.js','src/test/testAll.js'],
